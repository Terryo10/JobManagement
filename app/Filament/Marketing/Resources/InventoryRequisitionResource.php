...
use App\Filament\Marketing\Resources\InventoryRequisitionResource\Pages;
...
/**
 * Marketing-panel requisition resource.
 * Marketing staff can submit and track their own item/tool requests,
 * and confirm procurement steps for requests they raised.
 */
class InventoryRequisitionResource extends Resource
{
    ...
    /**
     * Marketing users only see their own requisitions.
     */
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                // ── Confirm purchased (marketing staff bought the item) ──────────
                Tables\Actions\Action::make('confirm_purchased')
                    ...
                    ->modalDescription('Confirm that you have purchased the item with the issued funds.')
                    ->form([
                    ...
                    ->action(function ($record, array $data) {
                        try {
                            ...
                            Notification::make()
                                ...
                                ->body('The next step is to confirm you have the items in hand.')
                                ->success()
                                ->send();
                ...
                Tables\Actions\Action::make('confirm_received')
                    ...
                    ->form([
                        Forms\Components\TextInput::make('quantity_received')
                            ...
                            ->minValue(0.01)
                            ->step(0.01)
                            ->helperText('Enter the actual quantity you have. This adds it to stock and marks your request as fulfilled.'),
                        Forms\Components\Textarea::make('notes')
